...
author: "Anupriya Tripathi, Aaron Gilbert, Curran Bhatia, Nick Favale, Krti Tallam"
...
\
This indicates that running Bayesian Applications on Monte Carlo produces a roughly normal distribution. The postC y-axis represents a posterior distribution divided by a constant C to make normalize the data. 
\
...
This graph represents the final posterior distribution after 2008 to 2010 yearly data simulation. This is distribution is the final of a Markov Chain that went from March 2008, March 2009, March 2010. As can be seen, the y-axis is not well normalized; however, its important to note that the ratio is what the S&P 500 distribution looks like.
...
This is another Markov Model that represents March 2005 to March 2008. Similar to the last model, the y-axis is not normalized to the extent where the values are correct, but the ratio does represent the distribution well.
