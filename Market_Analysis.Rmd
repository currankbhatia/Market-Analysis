...
author: "Aaron Gilbert, Anupriya Tripathi, Curran Bhatia, Nick Favale, Krti Tallam  "
...
It is important to note here that the names of the companies was not necessary for our analysis, so it did not affect our results or predictions. Our final dataset after processing is shown below (Figure 2).
...
This graph represents the final posterior distribution after 2008 to 2010 yearly data simulation. This distribution is the final of a Markov Chain that went from March 2008, March 2009, March 2010. As can be seen, the y-axis is not well normalized; however, its important to note that the ratio is what the S&P 500 distribution looks like. We can verify that this is accurate because the S&P 500 stock price was 1,316.94 on March 1, 2008 and was 1,152.05 on March 1, 2010. So the percent returns for this time period was about -14%. Since the peak of our curve is slightly before 0 on the x-axis we know this is accurate.
...
Overall, the conclusion we can still take away from this experiment is that one can simply randomly pick stocks from the S&P 500, and they are likely to have a distribution similar to the S&P 500, and likely to have limited risk in the investment.
